...
export const HeroView = ({ hero }: Props) => {
    ...
    return (
      <div className={`flex w-full flex-row md:w-[60%] ${className}`}>
        ...
        <Link
          ...
          className="transition-z -z-1 flex aspect-square w-1/6 flex-col items-center justify-center border-2 border-[#2c2e2e] transition-transform hover:z-50 hover:scale-125"
        >
          <div
  ...
  const renderSkillBox = (skill, image) => {
    return (
      <div className="relative z-0 aspect-square w-1/6 border-2 border-[#2c2e2e] bg-black transition-all hover:z-50 hover:scale-125 md:w-[10%]">
        {hero.skill1Image && (
